...
# 生成站台导向标识
sign = Sign(2048, 128)
sign.add_element(NumberLine(108, 1), "middle")
...
# 生成出口标识
sign = Sign(1024, 256)
sign.add_element(ExitSign(108, "1,5-22"), "middle")
sign.add_element(Arrow(108, EXIT_COLOR, direction="up"), "middle")
...
sign.add_element(Arrow(128, direction="down"), "middle")
